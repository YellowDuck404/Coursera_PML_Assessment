...
```
## Model
Random Forest was selected for this project.
...
Random Forest algorithms generates model with `r round(100*confM$overall['Accuracy'],2)`% accuracy for validation dataset. That is good result therefore model will be used to predict on testing dataset.
